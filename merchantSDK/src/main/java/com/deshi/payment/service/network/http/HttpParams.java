package com.deshi.payment.service.network.http;
...
public class HttpParams {
    ...
    public static final String SANDBOX_URL = "https://dev-sdk.deshipay.com/";
    public static final String PRODUCTION_URL = "https://sdk.deshipay.com/";
